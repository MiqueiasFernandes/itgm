...
public class CustomizeResourceIntTest {
    ...
    private static final Long DEFAULT_PROJETO = 1L;
    private static final Long UPDATED_PROJETO = 2L;

    private static final Long DEFAULT_CENARIO = 1L;
    private static final Long UPDATED_CENARIO = 2L;
    ...
    public void createCustomize() throws Exception {
        ...
        assertThat(testCustomize.getProjeto()).isEqualTo(DEFAULT_PROJETO);
        assertThat(testCustomize.getCenario()).isEqualTo(DEFAULT_CENARIO);
    ...
    public void getAllCustomizes() throws Exception {
        ...
        restCustomizeMockMvc.perform(get("/api/customizes?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].projeto").value(hasItem(DEFAULT_PROJETO.intValue())))
            .andExpect(jsonPath("$.[*].cenario").value(hasItem(DEFAULT_CENARIO.intValue())))
    ...
    public void getCustomize() throws Exception {
        ...
        restCustomizeMockMvc.perform(get("/api/customizes/{id}", customize.getId()))
            ...
            .andExpect(jsonPath("$.projeto").value(DEFAULT_PROJETO.intValue()))
            .andExpect(jsonPath("$.cenario").value(DEFAULT_CENARIO.intValue()))
    ...
    public void updateCustomize() throws Exception {
        ...
        assertThat(testCustomize.getProjeto()).isEqualTo(UPDATED_PROJETO);
        assertThat(testCustomize.getCenario()).isEqualTo(UPDATED_CENARIO);
